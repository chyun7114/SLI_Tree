<template>
  <div class="mx-auto mb-8 w-full overflow-x-auto">
    <p class="mx-auto mb-4 w-max min-w-full whitespace-nowrap text-lg font-bold uppercase tracking-[0.34em] text-blue-600/85">26.하 삼성생명 신입입문교육</p>
    ...
    <p class="mx-auto mt-4 max-w-xl text-base leading-7 text-blue-700/85">
      아래 입력창을 클릭하여 AI에게 요청을 보내시면 아카이브가 만들어집니다.
    </p>
  </div>
</template>
